...
public class CatchAllGetEndpoint(IConfiguration configuration) : Endpoint
{
    [HttpGet("{*url}")]
    public WebResult TestGet()
    {
        ...
        ConsoleLog.WriteMagenta($"Configuration testing | configuration[\"david\"] := <{configuration["david"]}>");
